...
const RentalRegistration = () => {
  ...
  const fetchData = async () => {
    try {
      const [reservationRes, categoriesRes, branchesRes, employeeRes] =
        await Promise.all([
  ...
  const handleRental = async (reservationId) => {
    try {
      ...
      const msg =
        ...
        'Error desconocido al procesar el alquiler.'
      alert(msg)
    }
  }
    ...
    >
      ...
      >
        <CardContent>
          ...
          <Divider
            sx={{ mb: 3, backgroundColor: theme.palette.charcoal, height: 2 }}
          />
          ...
          <Grid container spacing={2} direction="column">
            {reservations.length > 0 ? (
                ...
                <Grid item key={reservation.reservation_id}>
                  ...
                  >
                    ...
                    <Typography variant="body1" textAlign="center">
                      ...
                      {getCancelationPolicy(reservation.vehicle_category)}
                    </Typography>
                    ...
                    >
                      <Button
                        ...
                        onClick={() => {
                          if (
                            window.confirm(
                              '¿Confirmás dar de alta este alquiler?'
                            )
                          ) {
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (
                            window.confirm(
                              '¿Querés anular esta reserva por falta de disponibilidad?'
                            )
                          ) {
              ...
              <Grid item>
                ...
                >
                  <InfoPaper>
                    No hay reservas activas para dar de alta.
                  </InfoPaper>
                </Box>
              </Grid>
            )}
