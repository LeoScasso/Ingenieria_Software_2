      ...
      items: [
        {
          ...
          text: 'Alta de alquileres',
        },
        {
          to: '/rental-history-emp',
          icon: <HistoryIcon />,
          text: 'Historial Alquileres',
        },
      ...
      items: [
        {
          ...
          icon: <BuildIcon />,
          text: 'Vehículos en Mantenimiento',
        },
      ],
    },
    {
  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          to: '/rented-vehicles-metric',
          icon: <InsightsIcon />,
          text: 'Vehículos Alquilados',
        },
      ],
    },
    {
    ...
    sections.map((section, idx) => (
      <Box key={idx}>
        {section.label && (
          <>
            <Divider />
            <ListSubheader sx={{ bgcolor: 'Cornsilk' }}>
              {section.label}
            </ListSubheader>
            <Divider />
          </>
    ...
    <Box sx={{ width: 280 }} role="presentation">
      ...
      <List>
        {userName ? (
          ...
          <>
            {!hideLoginButton && (
              <Item to="/login" icon={<LoginIcon />} text="Iniciar sesión" />
            )}
            {!hideRegisterButton && (
              <Item
                to="/register"
